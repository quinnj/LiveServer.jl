...

{
    ...
    "title": "How it works",
    "category": "section",
    "text": "This is a rough overview of how this package works. Let\'s assume you have a directory similar to that generated by LiveServer.example():.\n├── css\n│   └── master.css\n├── files\n│   ├── TestImage.gif\n│   ├── TestImage.jpg\n│   ├── TestImage.png\n│   └── zip-file.zip\n├── index.html\n└── pages\n    └── blah.htmlAfter launching serve() in that directory, you may visit in your browser the page http://localhost:8000/index.html. This initiates a GET request from the browser which is caught by a listener loop in LiveServer. The requested file (here index.html) is then sent to the client after injection of a small script. This small script will trigger a reload of the page upon receiving a message to do so.If you now modify the page index.html, LiveServer will detect that the file has been modified and send a message to the small script above to trigger the reload."
},

{
    "location": "man/functionalities/#",
...
{
    "location": "man/functionalities/#Main-functions-1",
    "page": "Functionalities",
    "title": "Main functions",
    "category": "section",
    "text": "The two main functions exported by LiveServer are serve and servedocs."
},

{
    "location": "man/functionalities/#serve-1",
    "page": "Functionalities",
    "title": "serve",
    "category": "section",
    "text": "The exported serve function is the main function of the package. The basic usage isjulia> cd(\"directory/of/website\")\njulia> serve()\n✓ LiveServer listening on http://localhost:8000/ ...\n  (use CTRL+C to shut down)which will make the content of the folder available to be viewed in a browser.You can specify the port that the server should listen to as well as the directory to serve if not the current one (see serve). You can also specify the filewatcher which allows to determine what will trigger the messages to the client and ultimately cause the active browser tabs to reload.By default, it is file modifications that will trigger page reloads but you may want to write your own file watcher to perform additional actions upon file changes or trigger browser reload differently.See the section on Extending LiveServer for more informations."
},

{
    "location": "man/functionalities/#servedocs-1",
    "page": "Functionalities",
    "title": "servedocs",
    "category": "section",
    "text": "The exported servedocs function is a convenient function derived from serve. The main purpose is to allow Julia package developpers to live-preview their docs while working on it by coupling Documenter.jl and LiveServer.jl.Let\'s assume the structure of your package looks like.\n├── LICENSE.md\n├── Manifest.toml\n├── Project.toml\n├── README.md\n├── docs\n│   ├── Project.toml\n│   ├── build\n│   ├── make.jl\n│   └── src\n│       └── index.md\n├── src\n│   └── MyPackage.jl\n└── test\n    └── runtests.jl\nThe standard way of running Documenter.jl is to run make.jl, wait for completion and then maybe use a third party tool to see the output. With servedocs, you can edit the .md files in your docs/src and see the changes being applied directly in your browser which makes writing documentation easier.julia> # we assume here that you are in MyPackage.jl/\njulia> servedocs()This will execute make.jl (a pass of Documenter.jl) before serving the resulting docs/build folder. Upon modifying a .md file (e.g. updating docs/src/index.md), a pass of Documenter.jl will be applied and the corresponding changes propagated to tabs currently watching http://localhost:8000/index.html.Notes:the first pass of Documenter.jl is relatively slow but subsequent passes are quite fast so that the workflow with Documenter.jl+LiveServer.jl does not suffer from large delays,\nyou can stop the procedure using CTRL+C,\nif you add new files to the src/ folder, you will have to stop and restart servedocs otherwise the file will not be considered."
},

{
    "location": "man/extending_ls/#",
    "page": "Extending LiveServer",
    "title": "Extending LiveServer",
    "category": "page",
    "text": ""
},

{
    "location": "man/extending_ls/#Extending-LiveServer-1",
    "page": "Extending LiveServer",
    "title": "Extending LiveServer",
    "category": "section",
    "text": "TBA"
...
{
    "location": "lib/internals/#File-watching-1",
    "page": "Internals",
    "title": "File watching",
    "category": "section",
    "text": "There are two key types related to file watching:one to wrap a file being watched (LiveServer.WatchedFile),\none for the file watcher itself wrapping the list of watched files and what to do upon file changes (\"callback\" function)Any file watcher will be a subtype of the abstract type LiveServer.FileWatcher with, for instance, the default watcher being LiveServer.SimpleWatcher."
},
...
{
    "location": "lib/internals/#LiveServer.is_running",
    "page": "Internals",
    "title": "LiveServer.is_running",
    "category": "function",
    "text": "is_running(fw::FileWatcher)\n\nOptional API function to check whether the file watcher is running.\n\n\n\n\n\n"
},
...

{
    ...
    "title": "File watcher",
    "category": "section",
    "text": "Key typesLiveServer.FileWatcher\nLiveServer.SimpleWatcherFunctions related to a FileWatcherLiveServer.start\nLiveServer.stop\nLiveServer.set_callback!\nLiveServer.watch_file!\nLiveServer.file_watcher_task!Additional helper functions:LiveServer.is_running\nLiveServer.is_watched"
},
...
{
    "location": "lib/internals/#Miscellaneous-1",
    "page": "Internals",
    "title": "Miscellaneous",
    "category": "section",
    "text": "LiveServer.example"
},
